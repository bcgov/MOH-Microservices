...
//This simulates the real-life behavior of the API endpoint that the address-service connects to

import { testXML } from "./testXML.js";
import express from "express";
const app = express();

const MOCK_API_PORT = process.env.MOCK_API_PORT || 3001; //needs to match the address validator URL in start-local-service.sh
